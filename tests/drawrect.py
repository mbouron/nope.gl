...
def drawrect_translate(cfg: ngl.SceneCfg):
    ...
    return _canvas(cfg, ngl.DrawRect2D(rect=(64, 64, 128, 128), fill=fill, translate=(32.0, 32.0, 0.0)))
...
def drawrect_scale(cfg: ngl.SceneCfg):
    ...
    return _canvas(cfg, ngl.DrawRect2D(rect=(64, 64, 128, 128), fill=fill, scale=(0.5, 0.5, 1.0)))
...
@ngl.scene(width=W, height=H)
def drawrect_custom_mrt(cfg: ngl.SceneCfg):
    ...
    rtt = ngl.RenderToTexture(offscreen, [tex0, tex1])
    ...
    return _canvas(cfg, rtt, left, right)
