...
void main()
{
    ...
    float radiusNotch = 6e-2;
    
    vec2 sizeNotch = vec2(0.185, paddingV) - radiusNotch;
    vec2 offsetP2 = vec2(0., -1. + 0. * sizeNotch.y) + 5e-3 * vec2(noise1d(20. + 10. * s_time), noise1d(30. + 10. * s_time));
