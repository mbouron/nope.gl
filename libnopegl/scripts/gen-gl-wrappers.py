...
def gen(gl_xml, func_file):
    do_not_edit = "/* DO NOT EDIT - This file is autogenerated */\n"

    header = do_not_edit + textwrap.dedent(
        """
    ...
    content = header + glfunctions + gldefinitions + footer
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: %s <gl.xml> <func.h>" % sys.argv[0])
        sys.exit(1)
    gen(*sys.argv[1:])
