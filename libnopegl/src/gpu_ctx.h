...
struct gpu_ctx_class {
    ...
    int (*bindgroup_set_texture)(struct bindgroup *s, int32_t index, const struct texture_binding *binding);
    int (*bindgroup_set_buffer)(struct bindgroup *s, int32_t index, const struct buffer_binding *binding);
    int (*bindgroup_update)(struct bindgroup *s, const struct bindgroup_update_params *params);
