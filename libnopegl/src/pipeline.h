...
void ngli_pipeline_apply_reframing_matrix(struct ngli_pipeline *s, int32_t index, const struct image *image, const float *reframing, struct ngpu_staging_buffer *staging);
void ngli_pipeline_update_image(struct ngli_pipeline *s, int32_t index, const struct image *image, struct ngpu_staging_buffer *staging);
