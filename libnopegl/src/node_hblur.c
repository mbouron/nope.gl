...
static void hblur_uninit(struct ngl_node *node)
{
    ...
    ngli_image_resource_freep(&s->image);
    ngli_image_resource_freep(&s->map_image);
    ngli_image_resource_freep(&s->pass1_images[0]);
    ngli_image_resource_freep(&s->pass1_images[1]);
}
