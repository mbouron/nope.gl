...
static VkResult enumerate_physical_devices(struct vkcontext *s, const struct ngpu_ctx_params *config)
{
...
static VkResult select_physical_device(struct vkcontext *s, const struct ngpu_ctx_params *config)
{
    static const struct {
        const char *name;
        uint32_t priority;
