...
enum param_type {
    NGLI_PARAM_TYPE_I32      = NGL_PARAM_TYPE_I32,
    NGLI_PARAM_TYPE_IVEC2    = NGL_PARAM_TYPE_IVEC2,
    NGLI_PARAM_TYPE_IVEC3    = NGL_PARAM_TYPE_IVEC3,
    NGLI_PARAM_TYPE_IVEC4    = NGL_PARAM_TYPE_IVEC4,
    NGLI_PARAM_TYPE_BOOL     = NGL_PARAM_TYPE_BOOL,
    NGLI_PARAM_TYPE_U32      = NGL_PARAM_TYPE_U32,
    NGLI_PARAM_TYPE_UVEC2    = NGL_PARAM_TYPE_UVEC2,
    NGLI_PARAM_TYPE_UVEC3    = NGL_PARAM_TYPE_UVEC3,
    NGLI_PARAM_TYPE_UVEC4    = NGL_PARAM_TYPE_UVEC4,
    NGLI_PARAM_TYPE_F64      = NGL_PARAM_TYPE_F64,
    NGLI_PARAM_TYPE_STR      = NGL_PARAM_TYPE_STR,
    NGLI_PARAM_TYPE_DATA     = NGL_PARAM_TYPE_DATA,
    NGLI_PARAM_TYPE_F32      = NGL_PARAM_TYPE_F32,
    NGLI_PARAM_TYPE_VEC2     = NGL_PARAM_TYPE_VEC2,
    NGLI_PARAM_TYPE_VEC3     = NGL_PARAM_TYPE_VEC3,
    NGLI_PARAM_TYPE_VEC4     = NGL_PARAM_TYPE_VEC4,
    NGLI_PARAM_TYPE_MAT4     = NGL_PARAM_TYPE_MAT4,
    NGLI_PARAM_TYPE_NODE     = NGL_PARAM_TYPE_NODE,
    NGLI_PARAM_TYPE_NODELIST = NGL_PARAM_TYPE_NODELIST,
    NGLI_PARAM_TYPE_F64LIST  = NGL_PARAM_TYPE_F64LIST,
    NGLI_PARAM_TYPE_NODEDICT = NGL_PARAM_TYPE_NODEDICT,
    NGLI_PARAM_TYPE_SELECT   = NGL_PARAM_TYPE_SELECT,
    NGLI_PARAM_TYPE_FLAGS    = NGL_PARAM_TYPE_FLAGS,
    NGLI_PARAM_TYPE_RATIONAL = NGL_PARAM_TYPE_RATIONAL,
    NGLI_PARAM_TYPE_NB
};
...
/*
 * Remove @nodes from the node list at @dstp, matched by pointer, every
 * occurrence of each. The whole batch is validated first, so a node that is not
 * in the list, or one passed twice, leaves the list untouched.
 *
 * The list is compacted in place and its allocation is never shrunk, so the
 * slots the removal freed stay available: node_live.c puts a child back into
 * one of them when it takes a failed move back.
 */
