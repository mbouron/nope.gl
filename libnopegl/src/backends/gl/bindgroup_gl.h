...
int ngli_bindgroup_gl_set_texture(struct bindgroup *s, int32_t index, const struct texture_binding *binding);
int ngli_bindgroup_gl_set_buffer(struct bindgroup *s, int32_t index, const struct buffer_binding *binding);
int32_t ngli_bindgroup_gl_update(struct bindgroup *s, const struct bindgroup_update_params *params);
