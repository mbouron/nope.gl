...
struct stroke_opts {
    struct stroke_base_opts base_opts;
    float color[4];
};

static const char stroke_glsl[] =
    "vec4 ngli_stroke_color(vec2 uv) { return stroke_color; }\n";
...
static const char strokegradient_glsl[] =
    "vec4 ngli_stroke_color(vec2 uv) {\n"
...
static int strokegradient_init(struct ngl_node *node)
{
    ...
    si->opts = o;
    REGISTER_STROKE_UNIFORM(si, "sg_color0",          NGPU_TYPE_VEC3, struct strokegradient_opts, color0);
    REGISTER_STROKE_UNIFORM(si, "sg_color1",          NGPU_TYPE_VEC3, struct strokegradient_opts, color1);
    REGISTER_STROKE_UNIFORM(si, "sg_opacity0",        NGPU_TYPE_F32,  struct strokegradient_opts, opacity0);
    REGISTER_STROKE_UNIFORM(si, "sg_opacity1",        NGPU_TYPE_F32,  struct strokegradient_opts, opacity1);
    REGISTER_STROKE_UNIFORM(si, "sg_pos0",            NGPU_TYPE_VEC2, struct strokegradient_opts, pos0);
    REGISTER_STROKE_UNIFORM(si, "sg_pos1",            NGPU_TYPE_VEC2, struct strokegradient_opts, pos1);
    REGISTER_STROKE_UNIFORM(si, "sg_gradient_mode",   NGPU_TYPE_I32,  struct strokegradient_opts, gradient_mode);
    REGISTER_STROKE_UNIFORM(si, "sg_gradient_linear", NGPU_TYPE_I32,  struct strokegradient_opts, gradient_linear);
    return 0;
}
...
static const char strokegradient4_glsl[] =
    "#define ngli_sg4(tl,tr,br,bl,u) mix(mix(tl,tr,u.x),mix(bl,br,u.x),u.y)\n"
    "vec4 ngli_stroke_color(vec2 uv) {\n"
    ...
    "    float a = ngli_sg4(sg4_opacity_tl, sg4_opacity_tr, sg4_opacity_br, sg4_opacity_bl, uv);\n"
    "    if (sg4_gradient_linear != 0)\n"
    "        return vec4(ngli_linear2srgb(ngli_sg4(ngli_srgb2linear(tl),\n"
    "                                              ngli_srgb2linear(tr),\n"
    "                                              ngli_srgb2linear(br),\n"
    "                                              ngli_srgb2linear(bl), uv)), a);\n"
    "    return vec4(ngli_sg4(tl, tr, br, bl, uv), a);\n"
    "}\n";
...
static int strokegradient4_init(struct ngl_node *node)
{
    ...
    si->opts = o;
    REGISTER_STROKE_UNIFORM(si, "sg4_color_tl",        NGPU_TYPE_VEC3, struct strokegradient4_opts, color_tl);
    REGISTER_STROKE_UNIFORM(si, "sg4_color_tr",        NGPU_TYPE_VEC3, struct strokegradient4_opts, color_tr);
    REGISTER_STROKE_UNIFORM(si, "sg4_color_br",        NGPU_TYPE_VEC3, struct strokegradient4_opts, color_br);
    REGISTER_STROKE_UNIFORM(si, "sg4_color_bl",        NGPU_TYPE_VEC3, struct strokegradient4_opts, color_bl);
    REGISTER_STROKE_UNIFORM(si, "sg4_opacity_tl",      NGPU_TYPE_F32,  struct strokegradient4_opts, opacity_tl);
    REGISTER_STROKE_UNIFORM(si, "sg4_opacity_tr",      NGPU_TYPE_F32,  struct strokegradient4_opts, opacity_tr);
    REGISTER_STROKE_UNIFORM(si, "sg4_opacity_br",      NGPU_TYPE_F32,  struct strokegradient4_opts, opacity_br);
    REGISTER_STROKE_UNIFORM(si, "sg4_opacity_bl",      NGPU_TYPE_F32,  struct strokegradient4_opts, opacity_bl);
    REGISTER_STROKE_UNIFORM(si, "sg4_gradient_linear", NGPU_TYPE_I32,  struct strokegradient4_opts, gradient_linear);
    return 0;
}
