...
_EXTERNAL_DEPS = dict(
    ...
    moltenvk_Darwin=dict(
        ...
        sha256="5ea0c259df7ded9a275444820f09cced54d6e5a7c7a31d262de62a5cdb7e15cf",
    ),
    moltenvk_iOS=dict(
        version="1.4.1",
...
class _EnvBuilder(venv.EnvBuilder):
    ...
    def post_setup(self, context):
        ...
        pip_install += ["meson==1.10.0", "ninja"]
