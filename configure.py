...
_EXTERNAL_DEPS = dict(
    ...
    harfbuzz=dict(
        ...
        sha256="97ec7488a46b974e18e08ee774af93173e7e1dbf738424796eb315ebcb735ec5",
    ),
    fribidi=dict(
        version="1.0.16",
    ...
    moltenvk_iOS=dict(
        ...
        sha256="b5d947b1660e6e9fed40b9cd2387e160aaab9e80b775c0cef7e14059405178c1",
    ),
)
...
class _EnvBuilder(venv.EnvBuilder):
    ...
    def post_setup(self, context):
        ...
        pip_install += ["meson==1.12.0", "ninja"]
