...
class NopeGLTest {
    ...
    fun nodeGetters() {
        ...
        val rect = NGLDrawRect(rect = NGLVec4(10.0f, 20.0f, 100.0f, 80.0f), fill = fill)

        // Generated vec4 getter
        val v = rect.getRect()
        assertNotNull(v)
        ...
        // i32 getter
        val canvas = NGLCanvas(children = listOf(rect), width = 320, height = 240)
