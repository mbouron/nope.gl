...
enum class NGLNodeType(val type: Int) {
    ...
    COLORFILL(fourCharacters('C', 'l', 'F', 'l')),
    CUSTOMFILL(fourCharacters('C', 'u', 'F', 'l')),
    ...
    NOISEFILL(fourCharacters('N', 's', 'F', 'l')),
    ...
    STROKEGRADIENT(fourCharacters('S', 'G', 'r', 'd')),
    STROKEGRADIENT4(fourCharacters('S', 'G', '4', 'c')),
    ...
    TEXTUREFILL(fourCharacters('T', 'x', 'F', 'l')),
