...
enum class NGLNodeType(val type: Int) {
    ...
    CANVAS2D(fourCharacters('C', 'n', 'v', 's')),
    ...
    COLORPAINT(fourCharacters('C', 'l', 'P', 't')),
    CUSTOMPAINT(fourCharacters('C', 'u', 'P', 't')),
    ...
    GRADIENT4PAINT(fourCharacters('G', '4', 'P', 't')),
    GRADIENTPAINT(fourCharacters('G', 'r', 'P', 't')),
    GRADIENTSTOP(fourCharacters('G', 'S', 't', 'p')),
    GRADIENTSTOPS(fourCharacters('G', 'S', 't', 's')),
    ...
    LINEARGRADIENTPAINT(fourCharacters('L', 'G', 'P', 't')),
    MEDIA(fourCharacters('M', 'd', 'i', 'a')),
    NOISEPAINT(fourCharacters('N', 's', 'P', 't')),
    ...
    OFFSCREENCANVAS2D(fourCharacters('O', 'C', '2', 'D')),
    ...
    RADIALGRADIENTPAINT(fourCharacters('R', 'G', 'P', 't')),
    ...
    STROKE2D(fourCharacters('S', 't', '2', 'D')),
    SWEEPGRADIENTPAINT(fourCharacters('S', 'G', 'P', 't')),
    ...
    TEXTUREPAINT(fourCharacters('T', 'x', 'P', 't')),
    ...
    TIMERANGEFILTER2D(fourCharacters('T', 'R', 'F', '2')),
    ...
    USERSELECT2D(fourCharacters('U', 'S', 'l', '2')),
    USERSWITCH(fourCharacters('U', 'S', 'c', 'h')),
    USERSWITCH2D(fourCharacters('U', 'S', 'h', '2')),
