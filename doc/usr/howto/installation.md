...
"MINGW64" should be visible in the prompt):
    ...
    pacman -S --needed git make mingw-w64-ucrt-x86_64-{toolchain,ffmpeg,python,python-watchdog,python-pillow,python-numpy,python-jinja,pyside6,meson,cmake,graphviz,vulkan-devel}
